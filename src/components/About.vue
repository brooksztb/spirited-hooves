...
<template>
    <v-container id="AboutUs">
        <v-layout column>
            <v-flex class="display-2 text-xs-center my-5 grey--text text--darken-3">Big Title Goes Here</v-flex>
            <v-flex>
                <div class="grey--text text--darken-3 headline mt-3">Lorem ipsum</div>
